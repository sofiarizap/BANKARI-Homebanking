...
public class Card {
  ...
  public Card(String cardHolder, CardType cardtype, CardColor cardColor, String number, int cvv, LocalDate fromDate, LocalDate thruDate, Client client, Boolean active) {
