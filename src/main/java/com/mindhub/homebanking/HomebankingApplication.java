...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository,
		...
		return (args) -> {
			...
			Loan mortgageLoan = new Loan("Mortgage", 500000.0, List.of(12, 24, 36, 48, 60),0.20 );
			Loan personalLoan = new Loan("Personal", 100000.0, List.of(6, 12, 24), 0.30);
			Loan autoLoan = new Loan("Auto", 300000.0, List.of(6, 12, 24, 36), 0.18);
			...
			Card card1= new Card(melbaClient.getFirstName()+" "+ melbaClient.getLastName(),CardType.DEBIT,GOLD,"1456-1573-5678-5678",180, LocalDate.now(),LocalDate.now().plusYears(5),melbaClient,true);
			Card card2= new Card(melbaClient.getFirstName()+" "+ melbaClient.getLastName(),CardType.DEBIT,SILVER,"2456-1573-2278-5678",180, LocalDate.now(),LocalDate.now().plusYears(5),melbaClient,true);
			Card card3= new Card(melbaClient.getFirstName()+" "+melbaClient.getLastName(),CardType.CREDIT,TITANIUM,"2563-1489-8690-5678",623,LocalDate.now(),LocalDate.now().plusYears(5),melbaClient, true);
			Card card4= new Card(melbaClient.getFirstName()+" "+melbaClient.getLastName(),CardType.CREDIT,GOLD,"2403-1489-3090-5678",433,LocalDate.now().minusYears(6),LocalDate.now().minusMonths(12),melbaClient, true);
