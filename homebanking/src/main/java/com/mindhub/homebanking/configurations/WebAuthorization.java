...
public class WebAuthorization extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception{
    http.authorizeRequests()
            ...
            .antMatchers("/rest/**","/manager.html").hasAuthority("ADMIN")
            .antMatchers(HttpMethod.GET,"/api/clients", "/api/accounts", "/api/cards" ).hasAuthority("ADMIN")
            .antMatchers("/web/index.html","/web/accounts.html", "/web/account.html" ,"/web/cards.html",
                    "/web/create-cards.html","/web/loan-application.html").hasAnyAuthority("CLIENT","ADMIN")
